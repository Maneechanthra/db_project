...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2023 at 04:05 PM
...
CREATE TABLE `applications` (
  ...
  `Parents_occupation` varchar(100) NOT NULL,
...
INSERT INTO `applications` (`National_id`, `Tcas_round`, `Prefix_th`, `Firstname_th`, `Lastname_th`, `Prefix_en`, `Firstname_en`, `Lastname_en`, `Birth_date`, `Ethnicity`, `Nationality`, `Religion`, `Province`, `District`, `Sub_district`, `Home_no`, `Village_no`, `Street`, `Postal_Code`, `Telephone_number`, `Home_number`, `Email`, `Parents_occupation`, `Income_parents`) VALUES
('1399400010775', 1, 'นาย', 'สุเมธ', 'มณีจันทรา', 'Mr', '', 'Maneechanthra', '2023-02-10', 'ไทย', 'ไทย', 'พุทธ', '', '', '', '126', '8', '-', '41130', 630038428, '-', 'sumet.ma@ku.th', 'ชาวนา', '500000');
...
CREATE TABLE `education_student` (
  `National_id` varchar(20) NOT NULL,
  `Province_of_school` varchar(40) NOT NULL,
  `School_name` varchar(40) NOT NULL,
  `edu_qualification` varchar(20) NOT NULL,
  `stady_plan` varchar(40) NOT NULL,
  `gpax` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `education_student` (`National_id`, `Province_of_school`, `School_name`, `edu_qualification`, `stady_plan`, `gpax`) VALUES
('1399400010775', '10', '', '', '', 0);
...
ALTER TABLE `education_student`
  ADD KEY `fore_national_id_2` (`National_id`);
...
--
-- Indexes for table `register_major`
--
ALTER TABLE `register_major`
  ADD PRIMARY KEY (`Register_id`),
  ADD KEY `fore_national_id` (`National_id`),
  ADD KEY `Tcas_round` (`Tcas_round`),
  ADD KEY `fore_major` (`Major_id`);
...
--
-- Constraints for table `education_student`
--
ALTER TABLE `education_student`
  ADD CONSTRAINT `fore_national_id_2` FOREIGN KEY (`National_id`) REFERENCES `applications` (`National_id`);
...
--
-- Constraints for table `register_major`
--
ALTER TABLE `register_major`
  ADD CONSTRAINT `fore_major` FOREIGN KEY (`Major_id`) REFERENCES `major` (`Major_id`),
  ADD CONSTRAINT `fore_national_id` FOREIGN KEY (`National_id`) REFERENCES `applications` (`National_id`);
COMMIT;
